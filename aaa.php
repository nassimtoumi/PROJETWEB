...
<div class="md-form active-pink active-pink-2 mb-3 mt-0">
  	...
  	<div class="col-lg-10 mx-auto">
                    ...
                    <h1 class="text-uppercase"><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Participer dans Nos Evenement.</font></font></strong></h1>
                    <hr>
					<div class="md-form active-pink active-pink-2 mb-3 mt-0">
			...
			?>
					...
					<div class="panel price panel-red">
						...
						<div class="panel-footer">
							<a class="btn btn-lg btn-block btn-danger" href="participer.php">Rejoindre</a>
						</div>
					</div>
					<!-- /PRICE ITEM -->
